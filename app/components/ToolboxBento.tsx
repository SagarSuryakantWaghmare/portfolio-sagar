...
const items = skillsItems
  .map((item, index) => (
    <div key={item.title} className="group inline-block text-center">
      <div
        className={`rounded-[20px] border border-border-primary p-2 transition-all duration-500 group-hover:border-orange-primary ${
          index === 2
    ...
    <BentoCard linkTo={linkTo} height="md:h-[304px] lg:h-[300px]">
      ...
      <div className="z-20 text-center">
        ...
        <p className="mt-1 text-text-secondary">
          Check out my technical skills and technologies.
        </p>
      </div>
