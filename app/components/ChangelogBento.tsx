...
export function ChangelogBento() {
  const changelogItems = [
    { title: "Portfolio V1 is Now Live!", publishedAt: "2024-12-21" },
    { title: "Added Connections Page", publishedAt: "2024-12-20" },
    { title: "Implemented Skills Section", publishedAt: "2024-12-19" },
    { title: "Orange Theme Applied", publishedAt: "2024-12-18" },
  ];
